...
// must be in UTF-8 or `basename` doesn't work
 ...
 echo "<br><br>     REQUEST FILE: ".$_REQUEST['file'];
    ...
    <script>
        ...
        $(function(){
            ...
            $('#table').on('click','.rename',function(data) {
                ...
                let newFileName = prompt("Nom du fichier", $(this).attr('data-file'));
                ...
                $.post("",{'do':'rename',file:$(this).attr('data-file'),xsrf:XSRF, 'newname':newFileName},function(response){
                    list();
                },'json');
                return false;
            });
        ...
        <?php endif; ?>
            ...
            function renderFileRow(data) {
                ...
                var $rename_link = $('<a/>').attr('href','?do=rename&file='+ encodeURIComponent(data.path)).attr('data-file',data.path)
                    .addClass('rename').text('renommer');
